Creates a playlist that alternates between songs from a specific artist or album and songs from a specifc playlist. Written in javascript using MacOS's Script Editor.
